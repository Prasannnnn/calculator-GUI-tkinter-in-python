...
class Calc(object):
    def __init__(self, parent=tk.Tk()):
        self.parent = parent
        self.parent.title("Python  Calculater")
...
# number keypad creation
        ...
        self.bt_clear = tk.Button(self.parent, text="clr", command=self.clear)
...
#clear the display
    ...
    def about(self):
        ...
        tk.Label(about_window, text="Va Arunachalam ",font=("Times New Roman",15,"bold")).grid(row=0,column=0,padx=5,pady=5,sticky="s")
        tk.Label(about_window, text="Simple Calculator",font=("Times New Roman",12,"bold")).grid(row=1,column=0, padx=5, pady=5,sticky="s")
        tk.Label(about_window, text="Developed by prasan 4362",font=("Times New Roman",12,"bold")).grid(row=2, column=0, sticky="s", padx=5)
        tk.Label(about_window, text="I am Batman",font=("Times New Roman",12,"bold")).grid(row=3,column=0,sticky="s",padx=5)
